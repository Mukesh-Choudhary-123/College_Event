            ...
            <div class="sub_main">
                <div class="info_div">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($conn->connect_error) {
                            ...
                            $stmt = $conn->prepare("INSERT INTO bollywood_event(uname, fname, roll, year) VALUES(?, ?, ?, ?)");
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        <div class="form_heading">
                            <h1 id="h1_from_heading">participate in Bollywood Event</h1>
                        </div>
                        ...
                        <div class="year_div" id="input">
                            ...
                            <select id="myss" name="year" required>
                ...
                <div class="event_entery">
                    ...
                    if ($conn->connect_error) {
                        ...
                        $query = "SELECT * FROM bollywood_event";
                        $result = $conn->query($query);

                        if ($result->num_rows > 0) {
                            echo "Bollywood Event Enteries";
                            echo "<table border='1'>
                                  <tr>
                                  <th>Sr.no</th>
                                  <th>Student name</th>
